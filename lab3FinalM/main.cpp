               ...
               if(lectura == cajero){
                   ...
                   if(sn == 's' || sn == 'S'){
                       ...
                       decodificarUser = decodificacionCajero(semillaCajero,lecturaUser);
                        ...
                        while (decodificarUser.find(cedula)!=string::npos){ //Si es diferente, pertenece al string (npos)
                            cout << "Este usuario ya se encuentra registrado\nFavor volver a ingresar cedula "; cin>> cedula;
                            validar(cedula, 1);
                            lecturaUser = leer("usuario.dat",false);
                            decodificarUser = decodificacionCajero(semillaCajero,lecturaUser);
                        }
                     ...
                     while (MenuUsuario == 0) {
                         ...
                         while (entradaUsuario == 1) { // Consultar saldo
                             ...
                             if (saldo_mod < 1000){
                                 ...
                                 saldo_mod -= 1000;  //Hace la resta del saldo
                         ...
                         while (entradaUsuario == 2) { // Retirar saldo
                             ...
                             cout << "Por favor escriba la cantidad de dinero que desea retirar: "; cin >> retirar;
